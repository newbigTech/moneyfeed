...
public class UpdateCustomerPropertyReq {
	...
	@ApiModelProperty(notes = "允许线下交易")
	private String  allowOfflineBusiness;
	...
	public String getAllowOfflineBusiness() {
		return allowOfflineBusiness;
	}

	public void setAllowOfflineBusiness(String allowOfflineBusiness) {
