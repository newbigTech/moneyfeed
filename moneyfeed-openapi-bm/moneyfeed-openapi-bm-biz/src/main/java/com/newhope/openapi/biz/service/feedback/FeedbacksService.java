...
public class FeedbacksService {
	...
	public Result feedbackExport(FeedbackPageReq req, HttpServletResponse response) {
	    ...
	    if(!CollectionUtils.isEmpty(allTotal)){
	    	for(FeedbackItemResult feedbackItemResult : allTotal){
	    		if(MessageLabelTypeEnum.SYSTEM_TYPE.getCode().equals(feedbackItemResult.getMessageLabelType())){
	    			feedbackItemResult.setIntentionShopName("");
	    		}
	    	}
	    }
