package com.newhope.moneyfeed.integration.biz.rpc.feign;
...
public class FeignRequestInterceptor implements RequestInterceptor {
	...
	public void apply(RequestTemplate requestTemplate) {
		...
		requestTemplate.header(CommonConstant.HTTP_HEADER_SOURCE, request.getHeader(CommonConstant.HTTP_HEADER_SOURCE));
