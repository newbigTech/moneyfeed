package com.newhope.moneyfeed.goods.web.config;
...
public class SwaggerConfig {
    ...
    public Docket dock() {
		return new Docket(DocumentationType.SWAGGER_2).enable(enable)
				...
				.apis(RequestHandlerSelectors.basePackage("com.newhope.moneyfeed.goods.web.controller"))
	...
	private List<Parameter> setHeaderToken() {
		...
		tokenPar.name("TOKEN").description("用户认证的token").modelRef(new ModelRef("string")).parameterType("header").required(false).build();
