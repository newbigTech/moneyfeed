package com.newhope.moneyfeed.order.web.config;
...
public class SwaggerConfig {
    ...
    public Docket dock() {
		return new Docket(DocumentationType.SWAGGER_2).enable(enable)
				...
				.apis(RequestHandlerSelectors.basePackage("com.newhope.moneyfeed.order.web.controller"))
