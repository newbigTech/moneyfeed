package com.newhope.moneyfeed.order.message.biz.processer;
...
@Component("integrationToOrderProcesser")
public class IntToOrderProcessor extends ImmediateMessageProcessorTemplate {
	
	private static final Logger logger = LoggerFactory.getLogger(IntToOrderProcessor.class);
