package com.newhope.moneyfeed.user.message.receiver;
...
@Component
public class UserCheckMessageReceiver extends MessageReceiver implements ChannelAwareMessageListener {
	private static final Logger logger = LoggerFactory.getLogger(UserCheckMessageReceiver.class);

	@Autowired
	RabbitTemplate rabbitTemplate;
	
	@Autowired
	UserCheckEventConfig eventAMQPConfig;
	...
	public void onMessage(Message message, Channel channel) throws Exception {
		...
		try {
			...
			rabbitTemplate.convertAndSend(eventAMQPConfig.getUserCheckEventExchangeName(), eventAMQPConfig.getUserCheckEventBindingkey(), message,
