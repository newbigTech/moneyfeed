 ...
 *
 */
public class ClientUserShopApplyQueryReq extends PageDtoReq {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1899431789812089515L;
	/**
	 * 主键Id
	 */
	 @ApiModelProperty("主键")
	private Long userShopApplyId;
	...
	public Long getUserShopApplyId() {
		return userShopApplyId;
	}

	public void setUserShopApplyId(Long userShopApplyId) {
		this.userShopApplyId = userShopApplyId;
	}
