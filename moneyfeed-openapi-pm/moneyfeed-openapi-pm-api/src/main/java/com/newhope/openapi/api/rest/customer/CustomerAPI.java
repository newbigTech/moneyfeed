...
public interface CustomerAPI {
	...
	@ApiImplicitParams({
        ...
        @ApiImplicitParam(name = "labelIds", value = "标签", paramType = "query", required = false, dataType = "Array"),
        @ApiImplicitParam(name = "enable", value = "状态：true-启用；false-禁用", paramType = "query", required = false, dataType = "String"),
	...
	@ApiOperation(value = "导出客户", notes = "导出客户", protocols = "http")
	@ApiImplicitParams({
		@ApiImplicitParam(name = "shopId", value = "shopId", paramType = "query", required = false, dataType = "Long"),
		@ApiImplicitParam(name = "customerName", value = "客户名称", paramType = "query", required = false, dataType = "String"),
        @ApiImplicitParam(name = "customerAsName", value = "客户别名", paramType = "query", required = false, dataType = "String"),
	...
	@ApiImplicitParams({
        @ApiImplicitParam(name = "contactName", value = "员工姓名", paramType = "query", required = false, dataType = "String"),
        @ApiImplicitParam(name = "contactNobile", value = "员工手机", paramType = "query", required = false, dataType = "String"),
        @ApiImplicitParam(name = "customerName", value = "所属客户", paramType = "query", required = false, dataType = "String"),
        @ApiImplicitParam(name = "beginDatetime", value = "开始时间", paramType = "query", required = false, dataType = "String"),
        @ApiImplicitParam(name = "endDatetime", value = "结束时间", paramType = "query", required = false, dataType = "String"),
        @ApiImplicitParam(name = "roleId", value = "角色Id", paramType = "query", required = false, dataType = "Long"),
        @ApiImplicitParam(name = "activated", value = "激活状态", paramType = "query", required = false, dataType = "String"),
        @ApiImplicitParam(name = "page", value = "当前页", paramType = "query", required = true, dataType = "Long"),
        @ApiImplicitParam(name = "pageSize", value = "分页大小", paramType = "query", required = true, dataType = "Integer")
	})
	@RequestMapping(value = "/customer/employee/list", method = RequestMethod.GET, produces = {"application/json"})
	BaseResponse<CustomerContactListResult> queryCustomerEmployeeList(CustomerContactQueryReq customerQueryReq,
			HttpServletRequest request);
	
	@ApiOperation(value = "导出客户的员工", notes = "导出客户联系人", protocols = "http")
	@ApiImplicitParams({
		 @ApiImplicitParam(name = "contactName", value = "员工姓名", paramType = "query", required = false, dataType = "String"),
	        @ApiImplicitParam(name = "contactNobile", value = "员工手机", paramType = "query", required = false, dataType = "String"),
	        @ApiImplicitParam(name = "customerName", value = "所属客户", paramType = "query", required = false, dataType = "String"),
	...
	@RequestMapping(value = "/customer/employee/export", method = RequestMethod.GET, produces = {"application/json"})
    ...
    public BaseResponse<Result> updateCustomerEmployee(@Valid @RequestBody CustomerClientUserUpdateReq customerClientUserReq, HttpServletRequest request); 
	...
	public BaseResponse<CustomerLabelListResult> getCustomerLabel(@RequestParam(name="customerId",required=true)Long customerId, HttpServletRequest request);

	@ApiOperation(value = "编辑客户信息", notes = "编辑客户信息", protocols = "http")
	@RequestMapping(value = "/customer", method = RequestMethod.PUT, produces = {"application/json"})
	public BaseResponse<Result> updateCustomerLabel(@Valid @RequestBody CustomerUpdateReq customerUpdateReq, HttpServletRequest request);
	...
	BaseResponse<CustomerResult> getCustomerInfo(@RequestParam(name="customerId",required=true)Long customerId, HttpServletRequest request);
