...
@Validated
public class RolePostReq implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1695712114548413287L;
	...
	@ApiModelProperty(name="enable", notes="是否可用", required=true)
